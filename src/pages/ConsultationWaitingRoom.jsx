...
const ConsultationWaitingRoom = () => {
    ...
    return (
        <div className="flex flex-col flex-1 h-full bg-[#f8f9fc] overflow-hidden font-sans">
            ...
            <main className="flex-1 flex flex-col justify-center py-8 px-4 md:px-6 overflow-y-auto">
            ...
            {/* Bottom Disabled Input Section */}
            <footer className="w-full border-t border-slate-200 bg-white py-4 px-4 md:px-10 sticky bottom-0 z-40">
                <div className="max-w-[960px] mx-auto w-full">
                    <div className="relative w-full group">
                        {isSessionActive ? (
                            <div className="w-full h-12 md:h-14 bg-white rounded-lg md:rounded-xl border border-slate-300 flex items-center px-4 justify-between focus-within:ring-2 focus-within:ring-primary focus-within:border-transparent transition-all shadow-sm">
                                <input
                                    type="text"
