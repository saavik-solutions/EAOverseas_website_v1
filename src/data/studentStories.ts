export const longFormStories = [
    {
        ...
        challenge: {
            icon: "help",
            title: "The Challenge",
            text: "Marcus was overwhelmed by contradictory advice online. With a stellar academic record but zero knowledge of the UK's UCAS system, he felt stuck between three different engineering specializations."
        },
        outcome: {
            icon: "check_circle",
            title: "The Outcome",
            text: "Through personalized mentoring, we helped Marcus refine his personal statement and choose the right specialization. He secured admissions from 4 top-tier UK universities, eventually choosing Cambridge."
        },
        student: {
            name: "Marcus Thorne",
    ...
    },
    {
        ...
        challenge: {
            icon: "psychology",
            title: "The Strategy",
            text: "Anjali had the talent but lacked the financial means. We designed a \"Scholarship-First\" strategy, targeting institutions with generous endowment funds and helping her draft winning essays that highlighted her unique background."
        },
        outcome: {
            icon: "military_tech",
            title: "The Result",
            text: "Anjali was awarded a 75% tuition waiver at the University of Toronto. She's now pursuing her dream in International Relations and serves as a student ambassador for new arrivals."
        },
        student: {
            name: "Anjali Sharma",
        ...
        content: `
            ...
            <h3>A Life-Changing Email</h3>
            <p>I'll never forget the morning I saw the email from the University of Toronto. "Congratulations... Lester B. Pearson International Scholarship nominee... 75% tuition waiver." I screamed so loud my neighbors checked on us!</p>
            <p>Today, I'm not just studying International Relations; I'm living it. I'm debt-free and serving as a student ambassador, helping others navigate their own paths.</p>
        `
    },
    {
        id: "li-wei-story",
        ...
        challenge: {
            icon: "translate",
            title: "The Hurdle",
            text: "Li Wei was a brilliant coder but struggled with English proficiency. His IELTS score was stuck at 6.0, holding him back from top US universities despite his technical skills."
        },
        outcome: {
            icon: "school",
            title: "The Breakthrough",
            text: "Our intensive 8-week IELTS boot camp focused specifically on his weak areas. He achieved an 8.0 band and is now pursuing his Master's in Computer Science at Georgia Tech."
        },
        student: {
            name: "Li Wei",
            role: "MS CS, USA",
    ...
    },
    {
        ...
        challenge: {
            ...
            text: "Pragya had a lot of artwork but no cohesive portfolio. She didn't know how to curate her pieces to tell a story that would appeal to top design schools like Parsons."
        },
        outcome: {
            icon: "brush",
            title: "The Masterpiece",
            text: "We connected her with a mentor from the industry who helped curate and polish her portfolio. The result? Acceptance into Parsons School of Design with a merit scholarship."
        },
        student: {
            name: "Pragya Singh",
